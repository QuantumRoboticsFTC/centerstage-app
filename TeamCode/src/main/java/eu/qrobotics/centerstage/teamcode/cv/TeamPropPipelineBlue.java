...
public class TeamPropPipelineBlue extends OpenCvPipeline {
...
//        return maxAverage;
    ...
    public Mat processFrame (Mat input) {
        ...
        // 1920x1080
        Rect leftRect = new Rect(1, 500, 639, 300);
        Rect centRect = new Rect(640, 500, 639, 300);
        Rect rightRect = new Rect(1280, 500, 639, 300);
