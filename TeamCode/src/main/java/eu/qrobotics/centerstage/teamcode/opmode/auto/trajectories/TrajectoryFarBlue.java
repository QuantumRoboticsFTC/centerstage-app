...
public class TrajectoryFarBlue {
    ...
    public static List<Trajectory> centerstageTrajectories(int teamProp, boolean parkedRight) {
        ...
        if (teamProp == 1) {
            ...
            trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(270), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                    .lineToSplineHeading(new Pose2d(-37, 17, Math.toRadians(110)))
                    .build()
            );
            ...
            trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(270), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                    .lineToSplineHeading(new Pose2d(-34, 28, Math.toRadians(30)))
                    .build()
            );

            trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(30), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                    .lineToSplineHeading(new Pose2d(-37, 24, Math.toRadians(110)))
                    .splineToSplineHeading(new Pose2d(17, 11, Math.toRadians(180)), Math.toRadians(0))
                    .splineToSplineHeading(new Pose2d(48, 36.5, Math.toRadians(180)), Math.toRadians(0))
                    .build()
        ...
        trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(180), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                ...
                .splineToSplineHeading(new Pose2d(-57, 10, Math.toRadians(200)), Math.toRadians(180))
                .build()
        );

        trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(200), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                .lineToSplineHeading(new Pose2d(-59, 13, Math.toRadians(160)))
                .build()
        );
    ...
    public static List<Trajectory> trussTrajectories(int teamProp, boolean parkedRight) {
        ...
        if (teamProp == 1) {
            trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(270), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                    .lineToSplineHeading(new Pose2d(-43, 43, Math.toRadians(240)))
                    .build()
            );

            trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(240), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                    .lineToSplineHeading(new Pose2d(-40, 51, Math.toRadians(200)))
            ...
            trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(270), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                    .lineToSplineHeading(new Pose2d(-46, 32, Math.toRadians(300)))
                    .build()
            );

            trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(300), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                    .lineToSplineHeading(new Pose2d(-40, 51, Math.toRadians(200)))
                    .splineToSplineHeading(new Pose2d(0, 58, Math.toRadians(180)), Math.toRadians(0))
            ...
            trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(90), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                    .lineToSplineHeading(new Pose2d(-33.5, 38, Math.toRadians(340)))
                    .build()
            );

            trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(340), BASE_VEL_CONSTRAINT, BASE_ACCEL_CONSTRAINT)
                    .lineToSplineHeading(new Pose2d(-40, 47, Math.toRadians(200)))
